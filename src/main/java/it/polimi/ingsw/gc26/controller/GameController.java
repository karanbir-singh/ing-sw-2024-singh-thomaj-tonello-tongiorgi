            ...
            if (player.equals(game.getCurrentPlayer())) {
                if (player.getState().equals(PlayerState.CARD_PLAYED)) {
                    ...
                    if (removedCard != null) {
                        ...
                        if (game.getState() != GameState.END_STAGE && player.getPersonalBoard().getScore() >= 10 || (commonTable.getResourceDeck().getCards().isEmpty() && commonTable.getGoldDeck().getCards().isEmpty())) {
