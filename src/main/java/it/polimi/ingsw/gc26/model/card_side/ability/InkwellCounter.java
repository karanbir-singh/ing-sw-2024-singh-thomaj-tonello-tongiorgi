...
/**
 * This class represents a card with the ability to give extra points for each inkwell symbol present in the board.
 */
public class InkwellCounter extends GoldCardFront implements Serializable {
    /**
     * Creates a new instance of a InkwellCounter
     *
     ...
     */
    public InkwellCounter(Symbol sideSymbol, Map<Symbol, Integer> requestedResources, Corner UPLEFT, Corner DOWNLEFT, Corner UPRIGHT, Corner DOWNRIGHT, String imagePath) {
